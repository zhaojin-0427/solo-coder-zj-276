...
class PlantSpecies(models.Model):
    ...
    def get_seasonal_watering_days(self):
        ...
        if month in [6, 7, 8]:
            return max(1, int(self.base_watering_days * 0.6))
        elif month in [12, 1, 2]:
            return int(self.base_watering_days * 1.8)
        elif month in [3, 4, 5]:
            return int(self.base_watering_days * 0.8)
        else:
            return self.base_watering_days
